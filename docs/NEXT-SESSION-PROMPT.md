...
- **製品の方向 (ユーザー 11:45、`docs/research/PRODUCT-DIRECTION-2026-09.md`)**: 中に入るエンジン。P0 = ExecutionPlan / explain / strict plan → Engine / Session API + mlx-lm アダプター → 配布 (3.11+, uvx, doctor) → 常設ベンチ + fast-path hit rate → README。着手は 27B の decode (小 M qmm) の着地後。
