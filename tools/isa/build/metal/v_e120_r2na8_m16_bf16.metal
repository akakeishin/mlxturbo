...
[[kernel]] void custom_kernel_v_e120_r2na8_m16_bf16(
  ...
  uint3 threadgroup_position_in_grid [[threadgroup_position_in_grid]]) {
    ...
    // E120 QMV, width 16: inputs-per-group 8, 2 output rows
    // per simdgroup, so the weight column is read 2x for this width.
    constexpr int NA = 8;
    ...
    for (int k = 0; k < in_vec_size; k += block_size) {
        ...
        const device float* e_st = e_xsums
            + ((k / block_size) * 32 + int(simd_lid)) * 16 + first_m;
        #pragma unroll
...
template [[host_name("custom_kernel_v_e120_r2na8_m16_bf16_bfloat16_t_5120_17408")]] [[kernel]] decltype(custom_kernel_v_e120_r2na8_m16_bf16<bfloat16_t, 5120, 17408>) custom_kernel_v_e120_r2na8_m16_bf16<bfloat16_t, 5120, 17408>;
