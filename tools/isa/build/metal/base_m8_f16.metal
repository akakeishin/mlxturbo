...
[[kernel]] void custom_kernel_base_m8_f16(
  ...
  uint3 threadgroup_position_in_grid [[threadgroup_position_in_grid]]) {
    ...
    for (int group = (int)sg; group < groups; group += SPLITS) {
        ...
        for (int kt = 0; kt < QGROUP / 8; ++kt) {
            ...
            simdgroup_load(a0, x + (size_t)0 * K + k_base, K);
...
template [[host_name("custom_kernel_base_m8_f16_half_5120_17408")]] [[kernel]] decltype(custom_kernel_base_m8_f16<half, 5120, 17408>) custom_kernel_base_m8_f16<half, 5120, 17408>;
