...
[[kernel]] void custom_kernel_v_e120_table_m16_bf16(
  ...
  uint3 threadgroup_position_in_grid [[threadgroup_position_in_grid]]) {
    ...
    // E120 QMV, width 16: inputs-per-group 4, 4 output rows
    // per simdgroup, so the weight column is read 4x for this width.
    constexpr int NA = 4;
...
template [[host_name("custom_kernel_v_e120_table_m16_bf16_bfloat16_t_5120_17408")]] [[kernel]] decltype(custom_kernel_v_e120_table_m16_bf16<bfloat16_t, 5120, 17408>) custom_kernel_v_e120_table_m16_bf16<bfloat16_t, 5120, 17408>;
